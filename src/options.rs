...
pub struct WipOptions {
    ...
    pub source_file_const_name: Option<Cow<'static, str>>,
    ...
    pub get_fn_name: Option<Cow<'static, str>>,
...
impl WipOptions {
    pub const fn new() -> Self {
        WipOptions {
            ...
            impl_display: false,
            impl_from_str: false,
            source_file_const_name: Some(Cow::Borrowed("SOURCE_FILE")),
            ...
            get_fn_name: Some(Cow::Borrowed("get")),
